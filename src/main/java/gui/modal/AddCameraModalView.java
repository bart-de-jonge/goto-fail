...
public class AddCameraModalView extends ModalView {
    ...
    public AddCameraModalView(RootPane rootPane, EventHandler<AddCameraEvent> handler, ArrayList<CameraType> types) {
        this(rootPane, handler, types, width, height);
    }
    
    public AddCameraModalView(RootPane rootPane, EventHandler<AddCameraEvent> handler, ArrayList<CameraType> types, int width, int height) {
